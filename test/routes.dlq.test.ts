...
let app: ReturnType<typeof buildApp>, queue: ReturnType<typeof fakeQueue>, tenantA: TenantDoc, tenantB: TenantDoc
...
beforeEach(async () => {
  ...
  queue = fakeQueue()
  app = buildApp({ ingestQueue: queue as unknown as Queue })
})

const dlqDoc = (tenantId: mongoose.Types.ObjectId, extra: Record<string, unknown> = {}) =>
