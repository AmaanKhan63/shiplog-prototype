...
async function waitFor<T>(pred: () => T | Promise<T>, { timeout = 15000, interval = 50 } = {}) {
...
describe.skipIf(!available)('reconciliation poller (live Redis, fixture Nango)', () => {
  ...
  let reconcileQueue: ReturnType<typeof createReconcileQueue>
  let ingestWorker: ReturnType<typeof createIngestWorker>
  let reconcileWorker: ReturnType<typeof createReconcileWorker>
