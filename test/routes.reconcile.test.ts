...
import type { ConnectionDoc } from '../src/models/Connection.js'
...
let app: ReturnType<typeof buildApp>, queue: ReturnType<typeof fakeQueue>, tenantA: TenantDoc, tenantB: TenantDoc, connA: ConnectionDoc
...
beforeEach(async () => {
  ...
  queue = fakeQueue()
  app = buildApp({ reconcileQueue: queue as unknown as Queue })
})
