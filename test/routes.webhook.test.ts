...
import type { NangoSyncJobData } from '../src/queue/types.js'
...
let ingestQueue: ReturnType<typeof fakeQueue>
let nangoSyncQueue: ReturnType<typeof fakeQueue>
...
beforeEach(async () => {
  ...
  app = buildApp({ ingestQueue: ingestQueue as unknown as Queue, nangoSyncQueue: nangoSyncQueue as unknown as Queue<NangoSyncJobData>, nangoWebhookSecret: SECRET })
})

function signed(payloadObj: any, secret = SECRET) {
